        ...
        <LoadScript googleMapsApiKey={apiKey} libraries={["places"]}>
            <Modal isOpen={isOpen} onRequestClose={onClose}>
                <div className={classes.ModalContent}>
                    <Autocomplete onLoad={handleLoad} onPlaceChanged={handlePlaceSelect} className={classes.Control}>
                        <input
                            type="text"
                    ...
                    >
                        {selectedPlace && <Marker position={selectedPlace}/>} {/* Show marker at the selected place */}
                    </GoogleMap>
                    <Button onClick={confirmSelection} className={classes.Control}>Confirm Location</Button>
                </div>
            </Modal>
        </LoadScript>
    );
